...
// });
 ...
 Route::post('/SaiAutoCare/estimation/add','AstimateController@save');
 Route::get('/SaiAutoCare/estimation/search','AstimateController@view');
 Route::post('/SaiAutoCare/estimation/search','AstimateController@view');
 Route::post('/SaiAutoCare/estimation/update','AstimateController@save');
 Route::get('/SaiAutoCare/estimation/trash/{id}','AstimateController@trash');
 Route::get('/SaiAutoCare/estimation/delete','AstimateController@trashedList');
 Route::get('/SaiAutoCare/estimation/delete/{id}','AstimateController@permanemetDelete');
 Route::get('/SaiAutoCare/estimation/view/{id}','AstimateController@viewIndivisual'); 
 // Estimation :stop
