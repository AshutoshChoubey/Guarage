            ...
            <div class="card-body">
             <div class="row">
              <div class="col-md-6">
                ...
                {{Form::select('brand_id',$brand_select,isset($brand_id)?$brand_id: '', ['class' => 'form-control form-control ','required','id'=>'brand_id','required', 'placeholder' => '  Brand Name'] )}}
               </div>
               <div class="col-md-6">
   ...
   <div class="card-body"> 
    <div class="row">
       <div class="col-md-4">
          ...
          {{Form::select('brand_name',$brand_select,isset($brand_name)?$brand_name: '', ['class' => 'form-control form-control ','required','id'=>'brand_name','required', 'placeholder' => '  Service Type'] )}}
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          {{Form::select('service_name',$service_name_select,isset($service_name)?$service_name: '', ['class' => 'form-control form-control ','required', 'placeholder' => 'Service Name'] )}}
          <div class="invalid-feedback">
        ...
        <div class="col-md-4">
          ...
          {{Form::number('price',isset($price)?$price: '', ['class' => 'form-control form-control ','required', 'placeholder' => 'Price'] )}}
          <div class="invalid-feedback">
        ...
        <div class="col-md-4">
          <div class="form-group">
          <label class="form-col-form-label" for="sgst">SGST/UGST</label>
          {{Form::number('service_sgst',isset($service_sgst)?$service_sgst: 0, ['class' => 'form-control sgst igst1 ', 'placeholder' => 'SGST','step'=>'0.01'] )}}
          <div class="invalid-feedback">
          {{ $errors->has('sgst') ? $errors->first('sgst', ':message') : '' }}
          </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group">
          <label class="form-col-form-label" for="service_cgst">CGST</label>
          {{Form::number('service_cgst',isset($service_cgst)?$service_cgst: 0, ['class' => 'form-control cgst igst1', 'placeholder' => 'CGST','step'=>'0.01'] )}}
          <div class="invalid-feedback">
        ...
        <div class="col-md-4">
          <div class="form-group">
          <label class="form-col-form-label" for="service_igst">IGST</label>
          {{Form::number('service_igst',isset($service_igst)?$service_igst: 0, ['class' => 'form-control  igst  igst1', 'placeholder' => 'IGST','step'=>'0.01'] )}}
          <div class="invalid-feedback">
          {{ $errors->has('igst') ? $errors->first('igst', ':message') : '' }}
          </div>
          </div>
        </div>
        <div class="col-md-4">
          ...
          {{Form::number('service_gst',isset($service_gst)?$service_gst: 0, ['class' => 'form-control gst ', 'placeholder' => 'GST','step'=>'0.01'] )}}
          <div class="invalid-feedback">
          {{ $errors->has('gst') ? $errors->first('gst', ':message') : '' }}
          </div>
          </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
          <label class="form-col-form-label" for="gst">Discount Value</label>
          {{Form::number('service_discount',isset($service_discount)?$service_discount: 0, ['class' => 'form-control  ', 'placeholder' => 'Discount Value','step'=>'0.01'] )}}
          <div class="invalid-feedback">
          {{ $errors->has('gst') ? $errors->first('gst', ':message') : '' }}
          </div>
          </div>
...
<script type = "text/javascript" language = "javascript">
  $('#HideAll').on("click",function()
     ...
     $(document).on("change","[name^=brand_name]",function(){
      ...
      $('.igst1').on('change', function()
    {
    var sgst=$('.sgst').val();
    var cgst=$('.cgst').val();
    var igst=$('.igst').val();
    var totalgst=parseFloat(sgst)+parseFloat(cgst)+parseFloat(igst);
    $('.gst').val(totalgst);
    });    
</script>
@endsection