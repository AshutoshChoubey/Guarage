	...
	<table width="100%" border="3">
		...
		<tr>
			<td height="100px"  colspan="2">
				<b style="font-size: 19px;">WorldGyan AUTOMOBILE</b> <br>
				plot no-54547,dxfvdxvdxf<br>
				dfg Road,dfgdfg<br>
				dfgyn,pin-751024<br>
				mobile:5555555555,333333333<br>
				Email id:wxd@gmail.com
			</td>
			<td height="100px" >
				<img  src="{{ asset('img/new.jpg') }}" >
...
$forPay=($GrandTotalPriceForOneService+$TotaPart);
	 	...
	 	<tr>
	 		...
	 		<td colspan="3">For Worldgyan<br><br><br>
