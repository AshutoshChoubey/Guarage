...
<div class="card border-info">
   {{ Form::open(['url' => 'SaiAutoCare/estimation/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
   {{ csrf_field() }}
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-{{ session('message.level') }} alert-dismissible" onload="javascript: Notify('You`ve got mail.', 'top-right', '5000', 'info', 'fa-envelope', true); return false;">
              ...
              @if(isset($id))
              <div class="text-center text-primary"><a id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/estimation/view/{{ isset($id) ? $id : '' }}">Show Detail</a></div>
              <script type="text/javascript">
                $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                   var newTab = window.open("{{url('/')}}/SaiAutoCare/estimation/view/{{ isset($id) ? $id : '' }}", "_blank");
                      newTab.location;
              ...
              @else
               <div class="text-center text-primary"><a  id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/estimation/view/{{ isset($workshopId) ? $workshopId : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                 $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                    var newTab = window.open("{{url('/')}}/SaiAutoCare/estimation/view/{{ isset($workshopId) ? $workshopId : '' }}", "_blank");
                      newTab.location;
                   console.log("Worshop Detail Opened In New Tab");
                  },1000)
                })
                ...
                @endphp
                  ...
                  <td>
                    ...
                    <td  class="service_name">{{Form::select('product_id_es[]',$product, isset($value['product_id_es'])?$value['product_id_es']: '', ['class' =>  'form-control selectTo','required'=>'true','placeholder'=>'Select' ,isset($id)?'disabled="true"':'','id' => 'product_id'])}}
                       {{ Form::hidden('product_id_es[]', isset($id) ? $value['product_id_es'] :'', []) }} 
                    </td>
                    <td>
                    ...
                    <td><a href="javascript:void(0)" id="{{ $incrimentedId_es }}"   class="removeRowForProduct_es btn btn-danger btn-sm"><i class="fa fa-minus "></i></a></td>
...
$('[name=customer_id]').on("change",function(){
 ...
 var IdForUpdate="{{ isset($id) ? $id:null }}";
    ...
    var workshopId="{{ isset($workshopId) ? $workshopId:null }}";
      if(workshopId!="")
      {
       // location.href="{{url('/')}}/SaiAutoCare/estimation/view/"+workshopId;
      }
  });
</script>
@endsection