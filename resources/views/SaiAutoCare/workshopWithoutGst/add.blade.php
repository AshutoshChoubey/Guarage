...
<div class="card border-info">
   {{ Form::open(['url' => 'SaiAutoCare/workshopWTax/add','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
   {{ csrf_field() }}
   {{ Form::hidden('id', isset($id) ? $id :'', []) }} 
    <div class="card-header text-center">
            <h6 class="box-title text-primary ">Please Fill Up Workshop details Excluding Tax</h6>
    </div>
    @php
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-{{ session('message.level') }} alert-dismissible" onload="javascript: Notify('You`ve got mail.', 'top-right', '5000', 'info', 'fa-envelope', true); return false;">
              ...
              @if(isset($id))
              <div class="text-center text-primary"><a id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/workshopWTax/view/{{ isset($id) ? $id : '' }}">Show Detail</a></div>
              <script type="text/javascript">
                $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                   var newTab = window.open("{{url('/')}}/SaiAutoCare/workshopWTax/view/{{ isset($id) ? $id : '' }}", "_blank");
                      newTab.location;
              ...
              @else
               <div class="text-center text-primary"><a  id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/workshopWTax/view/{{ isset($workshopId) ? $workshopId : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                 $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                    var newTab = window.open("{{url('/')}}/SaiAutoCare/workshopWTax/view/{{ isset($workshopId) ? $workshopId : '' }}", "_blank");
                      newTab.location;
                   console.log("Worshop Detail Opened In New Tab");
                  },1000)
                })
