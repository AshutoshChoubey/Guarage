...
class WorkshopController extends Controller
{
   ...
   // this is for search 
    ...
    public function viewIndivisual($id)
    {
        ...
        ->select('products.product_name','workshop_products_estimateds.product_quantity_es','workshop_products_estimateds.product_price_es as ProductWorkshopPrice','products.hsn as ProductHsn','products.unit_price_exit as UnitExitPrice','products.gst as ProductGst','products.sgst as Productsgst','products.cgst as Productcgst','products.igst as Productigst','products.discount_value as discount_value')
